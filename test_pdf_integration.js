...
(async () => {
    console.log("=== INTEGRATION TEST: PDF Data + Qualification Logic ===\n");

    // Fetch data from PDFs
    console.log("1. Loading race data from PDFs...\n");
    ...
    if (w500m && w500m.length > 0) {
        ...
        console.log("No Women's 500m data found!");
    }
